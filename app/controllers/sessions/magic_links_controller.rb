  ...
  private
    def ensure_that_email_address_pending_authentication_exists
      unless email_address_pending_authentication.present?
        alert_message = I18n.t("flashes.enter_email_to_sign_in")
    ...
    def email_address_mismatch
      clear_pending_authentication_token
      alert_message = I18n.t("flashes.something_went_wrong_try_again")
    ...
    def invalid_code
      respond_to do |format|
        ...
        format.json { render json: { message: I18n.t("flashes.try_another_code") }, status: :unauthorized }
      end
    end
    ...
    def rate_limit_exceeded
      rate_limit_exceeded_message = I18n.t("flashes.try_again_in_15_minutes")
      respond_to do |format|
