  ...
  private
    ...
    def sign_up
      ...
      if signup.valid?(:identity_creation)
        ...
        respond_to do |format|
          format.html { redirect_to new_session_path, alert: I18n.t("flashes.something_went_wrong") }
          format.json { render json: { message: I18n.t("flashes.something_went_wrong") }, status: :unprocessable_entity }
        end
      end
    end
end
